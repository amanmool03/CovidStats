...
function fetchData(country) {
	...
	const api_fetch = async (country) => {
		await fetch(
				...
				country + "/status/confirmed",requestOptions
				)
		.then((res)=>{
			return res.json();
		})
		...
		await fetch(
				"https://api.covid19api.com/total/country/" + 
				country + "/status/recovered",requestOptions
				)
		.then((res)=>{
			return res.json();
		})
		...
		await fetch(
				"https://api.covid19api.com/total/country/" + 
				country + "/status/deaths",requestOptions
				)
		.then((res)=>{
			return res.json();
		})
...
function updateStats() {
	...
	new_deaths_element.innerHTML = `+${new_deaths_cases || 0}`;
